...
import { homeLevelTwo } from '../../../data/category/level-two/homeLevelTwo'
import { menLevelThree } from '../../../data/category/level-three/menLevelThree'
import { womenLevelThree } from '../../../data/category/level-three/womenLevelThree'
import { electronicsLevelThree } from '../../../data/category/level-three/electronicsLevelThree'
import { homeLevelThree } from '../../../data/category/level-three/homeLevelThree'
  ...
  return (
    <Box sx={{ zIndex: 2 }} className='bg-white shadow-lg lg:h-[500px] overflow-y-auto' >
      <div className='flex text-sm flex-wrap'>
        {
          categoryTwo[selectedCategory]?.map((item, index) => <div className={`p-8 lg:w-[20%] ${index % 2 === 0 ? "bg-slate-100" : "bg-white"}`}>
